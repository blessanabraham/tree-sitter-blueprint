...
enum {
  ...
  aux_sym__property_binding_repeat1 = 103,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [224] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__property_binding, 5),
  [226] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__property_binding_repeat1, 2),
  [230] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__property_binding_repeat1, 2), SHIFT_REPEAT(54),
